    ...
    <%
        ...
        if (session.getAttribute("tipo_utilizador") != null && Integer.parseInt(session.getAttribute("tipo_utilizador").toString()) == 3) {
            ...
            ResultSet rs = null;
                ...
                String sql = "SELECT c.nome AS nomeUti, u.nome AS nomeCurso, u.id_utilizador, c.id_curso, i.descricao AS descricao " +
                             "FROM inscricao i " +
    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="card shadow-lg p-3 mb-5 bg-white rounded w-75">
            <div class="card-body">
                ...
                <br>
                <form id="form1" name="form1" method="post" action="aceitarInscricao.jsp">
